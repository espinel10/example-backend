...
<body id="brindo-song">
            ...
            <nav class="navbar navbar-expand-md navbar navbar-dark brindo-navbar">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="client_home.php">Clientes</a>
                        </li>
                        <li class="nav-item">
    ...
    <h2 class="tittle" style="margin-left:30%">Agregar Clientes</h2>
...
//REGISTRA LOS DATOS EN LA BASE
    if(isset($_POST['registrarse'])){
        ...
        $insertarDatos = "INSERT INTO clients (name,city) VALUES('$nombre','$city')";
...
<h2 class="tittle" style="margin-left:30%">Actualizar</h2>
		<form action="#" class="formulario" id="formulario" name="formulario" method="POST">
            <div class="contenedor-inputs" style="margin-left:30%">
                <input type="number" name="id" placeholder="id-Clients"><br>
                <input type="text" name="name" placeholder="Nombre"><br>
                <input type="text" name="city" placeholder="ciudad"><br>
			</div>
...
//REGISTRA LOS DATOS EN LA BASE
    if(isset($_POST['actualizar'])){
        ...
        $nombre = $_POST["name"];
        $city=$_POST["city"];
        $insertarDatos = "UPDATE clients SET name='$nombre',city='$city' WHERE id_clients= '$id';";
...
<h2 class="tittle" style="margin-left:30%">Eliminar</h2>
		<form action="#" class="formulario" id="formulario" name="formulario" method="POST">
            <div class="contenedor-inputs" style="margin-left:30%">
                <input type="number" name="id" placeholder="Id-Client"><br>
			</div>
...
//REGISTRA LOS DATOS EN LA BASE
    if(isset($_POST['eliminar'])){
        $id = $_POST["id"];
        $insertarDatos = "DELETE FROM clients WHERE id_clients= '$id'";
...
<h2 class="tittle" style="margin-left:30%">Listas de Clientes</h2>
<?php
    //lista las ciudades
