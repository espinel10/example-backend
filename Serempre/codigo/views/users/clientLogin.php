...
?>
        ...
        <nav class="navbar navbar-expand-md navbar navbar-dark brindo-navbar">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="../formulario.php">Formulario con Ajax</a>
                    </li>
                </ul>
    ...
    <div class="login-client">
        <h2>Inicia Sesión</h2>
        <form action="../../scripts/check_login_client.php" method="post">
            <div class="form-group">
                ...
                <a id="olvidastelink" href="recuperar.php">¿Olvidaste tu contraseña?</a>
                <p id="demo"></p>
            </div>
        </form>
