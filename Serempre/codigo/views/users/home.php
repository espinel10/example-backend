...
<body id="brindo-song">
    ...
    <h2 class="tittle" style="margin-left:30%">Agregar Ciudades</h2>
...
//REGISTRA LOS DATOS EN LA BASE
    if(isset($_POST['registrarse'])){
        ...
        $insertarDatos = "INSERT INTO cities (name) VALUES('$nombre')";
...
<h2 class="tittle" style="margin-left:30%">Actualizar</h2>
		<form action="#" class="formulario" id="formulario" name="formulario" method="POST">
            <div class="contenedor-inputs" style="margin-left:30%">
                <input type="number" name="id" placeholder="Id-Ciudad"><br>
                <input type="text" name="name" placeholder="Nombre"><br>
			</div>
...
//REGISTRA LOS DATOS EN LA BASE
    if(isset($_POST['actualizar'])){
        ...
        $insertarDatos = "UPDATE cities SET name='$nombre' WHERE id_cities= '$id'";
...
//REGISTRA LOS DATOS EN LA BASE
    if(isset($_POST['eliminar'])){
        $id = $_POST["id"];
        $insertarDatos = "DELETE FROM cities WHERE id_cities= '$id'";
...
<h2 class="tittle" style="margin-left:30%">Listas de Ciudades</h2>
<?php
    //lista las ciudades
